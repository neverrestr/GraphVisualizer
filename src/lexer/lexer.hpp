...
namespace lexer {
    ...
    class Attribute_tt : public SymbolParser {
    void react(InputSpace const &event); // Метод для обработки события InputSpace
};
struct InputAttributeKey : public SymbolParser {
    std::string key;
};

struct EqualAttribute : public SymbolParser {
    void react(InputStringValue const &event);
};


class Attribute_h : public SymbolParser{
    void react(InputAttributeKey const &event); // Метод для обработки события InputAttributeKey
};
...
//     struct InputAttributeKey : lexemeEvent { std::string key; }; // <-- Добавлено
...
//         virtual void react(InputStringValue const &) { throw_invalid_input(""); };
//         virtual void react(InputIntValue const &) { throw_invalid_input(""); };
//         virtual void react(InputAttributeKey const &) { throw_invalid_input(""); }; // <-- Добавлено
...
//     class Attribute_h : public SymbolParser { // <-- Добавлено
//         void react(InputAttributeKey const &) override;
//     };

//     class Attribute_tt : public SymbolParser { // <-- Добавлено
//         void react(InputSpace const &) override;
//         void react(InputEqualLabel const &) override;
//     };

//     class EqualAttribute : public SymbolParser { // <-- Добавлено
//         void react(InputStringValue const &) override;
//         void react(InputIntValue const &) override;
//         void react(InputSpace const &) override;
//     };

//     // ... (оставшиеся существующие состояния) ...
...
//     class Digraph_D : public SymbolParser { void react(InputDigraph_i const &) override; };
//     class Digraph_i : public SymbolParser { void react(InputDigraph_g const &) override; };
//     class Digraph_g : public SymbolParser { void react(InputDigraph_r const &) override; };
//     class Digraph_r : public SymbolParser { void react(InputDigraph_a const &) override; };
//     class Digraph_a : public SymbolParser { void react(InputDigraph_p const &) override; };
//     class Digraph_p : public SymbolParser {
//         void react(InputDigraph_h const &) override;
//     };
//     class Digraph_h : public SymbolParser {
...
//     class Graph_G : public SymbolParser { void react(InputGraph_r const &) override; };
//     class Graph_r : public SymbolParser { void react(InputGraph_a const &) override; };
//     class Graph_a : public SymbolParser { void react(InputGraph_p const &) override; };
//     class Graph_p : public SymbolParser { void react(InputGraph_h const &) override; };
//     class Graph_h : public SymbolParser {
//         void react(InputOpenCurlyBracket const &) override;
//         void react(InputSpace const &) override;
//     };
...
//     // label
//     class Label_L : public SymbolParser { void react(InputLabel_a const &) override; };
//     class Label_a : public SymbolParser { void react(InputLabel_b const &) override; };
//     class Label_b : public SymbolParser { void react(InputLabel_e const &) override; };
//     class Label_e : public SymbolParser { void react(InputLabel_l const &) override; };
//     class Label_l : public SymbolParser {
//         void react(InputEqualLabel const &) override;
//         void react(InputSpace const &) override;
//     };
...
//     // weight
//     class Weight_w : public SymbolParser { void react(InputWeight_e const &) override; };
//     class Weight_e : public SymbolParser { void react(InputWeight_i const &) override; };
//     class Weight_i : public SymbolParser { void react(InputWeight_g const &) override; };
//     class Weight_g : public SymbolParser { void react(InputWeight_h const &) override; };
//     class Weight_h : public SymbolParser { void react(InputWeight_tt const &) override; };
//     class Weight_tt : public SymbolParser {
//         void react(InputEqualLabel const &) override;
//         void react(InputSpace const &) override;
//     };
